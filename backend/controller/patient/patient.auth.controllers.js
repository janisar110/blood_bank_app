...
export const patientRegistration = async (req, res) => {
  try {
    ...
    const userData = await PatientUser.create(obj);
    //webTokenSetCookie
    ...
    console.log("Error in patientSignup controller", error.message);
    res.status(500).json({
...
export const patientLogin = async (req, res) => {
  try {
    ...
    console.log("Error in patientLogin controller", error.message);
    res.status(500).json({
      message: "Internal server error",
    });
  }
...
export const patientLogout = async (req, res) => {
  try {
    ...
    console.log("Error in patientLogout controller", error.message);
    res.status(500).json({
      message: "Internal server error",
    });
  }
